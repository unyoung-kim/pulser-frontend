...
export default function ContentSettings() {
  ...
  const [loadingStages, setLoadingStages] = useState<LoadingStage[]>([
    { label: "Initializing content generation", isLoading: true, isComplete: false },
          ...
          <DialogContent className="sm:max-w-xl p-8">
            <DialogHeader className="space-y-3">
              ...
              <DialogDescription className="text-base leading-normal text-muted-foreground">
                Please don&apos;t leave this page. You can switch browser tabs while we work on your content.
            ...
            <div className="mt-8 space-y-6">
              {loadingStages.map((stage, index) => (
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <span className={`text-base ${stage.isLoading ? "text-primary font-medium" : "text-muted-foreground"}`}>
                    {stage.label}
                  </span>
                </div>
              ))}
